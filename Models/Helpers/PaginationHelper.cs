...
namespace MyFinances.Models.Helpers
{
    ...
    {
        public static PagedResponse<IEnumerable<T>> CreatePagedReponse<T>(IEnumerable<T> pagedData, PaginationFilter validFilter, int totalRecords, UriService uriService, string route)
        {
